...
## TDD 수행하기
### 칸반 보드 Unit Test 
1. KanbanCardForm이 올바르게 입력되면 KanbanCardForm 타입의 객체가 태스크 리스트에 추가된다.
2. 어떤 타입의 태스크가 태스크 리스트에 추가되면 해당 상태의 태스크 개수가 1개 증가한다.
...
6. 태스크가 정상적으로 생성되면 스낵바가 나타난다. 
7. 완료된 태스크가 없으면 0%가 표시된다.
